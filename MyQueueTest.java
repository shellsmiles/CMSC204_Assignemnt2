...
public class MyQueueTest {
	...
	public void testDequeueStudent() {
		...
		try {
			...
			assertEquals(2.1, doubleQ.dequeue(),0.01);
			assertEquals(3.1, doubleQ.dequeue(),0.01);
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		assertEquals("1.12.13.1", doubleQ.toString());
		doubleQ.enqueue(dd);
		assertEquals("1.12.13.14.1", doubleQ.toString());
		doubleQ.enqueue(ee);
		assertEquals("1.12.13.14.15.1", doubleQ.toString());
	}
